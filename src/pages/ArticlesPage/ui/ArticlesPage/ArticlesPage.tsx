...
const _article = {
    ...
    user: {
        ...
        avatar: 'https://yt3.googleusercontent.com/-CFTJHU7fEWb7BYEb6Jh9gm1EpetvVGQqtof0Rbh-VQRIznYYKJxCaqv_9HeBcmJmIsp2vOO9JU=s176-c-k-c0x00ffffff-no-rj',
    },
    type: [
        'IT',
    ],
    blocks: [
        ...
        },
        {
            ...
            paragraphs: [
                ...
                + ' Если до сих пор вы не написали ни строчки кода на JS и '
                + 'читаете этот текст в браузере, на настольном компьютере, это '
                + 'значит, что вы буквально в считанных секундах от '
...
const ArticlesPage = ({ className }: Props) => (
    <div className={classNames(cls.ArticlesPage, {}, [className])}>
        <ArticleList articles={_articles} view={ArticleView.GRID} isLoading />
    </div>
);
