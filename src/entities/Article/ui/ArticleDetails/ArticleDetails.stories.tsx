    ...
    blocks: [
        {
            ...
            paragraphs: [
                ...
                + 'Если до сих пор вы не написали ни строчки кода на JS и читаете '
                ...
                + 'Этот пример можно запустить и средствами данного ресурса '
                + '(ищите кнопку Try it Yourself), '
        ...
        },
        {
            ...
            paragraphs: [
                ...
                + 'приведённый на этом ресурсе. '
                + 'Этот пример можно запустить и средствами данного ресурса '
                + '(ищите кнопку Try it Yourself), но мы поступим немного иначе. '
                + 'А именно, создадим в каком-нибудь текстовом редакторе '
